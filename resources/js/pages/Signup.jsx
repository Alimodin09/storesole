                        ...
                        <div className={`auth-form-container ${isPageMounted ? 'is-visible' : ''}`}>
                            ...
                            <div className="auth-header auth-header--premium auth-header--centered">
                                ...
                                <p className="auth-subtitle">
                                    Create your account and shop school-ready styles faster.
                                </p>
                            </div>
                            ...
                            <div className="auth-footer-section">
                                ...
                                <Link to="/login" className="auth-footer-action auth-footer-action--primary">
                                    Sign In
                                </Link>
                            </div>
                        </div>
