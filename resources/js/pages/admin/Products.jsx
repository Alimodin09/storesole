...
export default function Products() {
    ...
    return (
        <section className="page page--admin-products">
            ...
            {editingProductId && (
                <form className="form-section admin-edit-form" onSubmit={handleEditSubmit}>
                    <div className="edit-form-header">
                        <h3>Edit Product</h3>
                        <p>Update all product fields including sizes and image.</p>
                    </div>
                    ...
                    <div className="form-group">
                        <label htmlFor="edit-image">Replace Main Image</label>
                        <input
                            id="edit-image"
                            name="image"
                            type="file"
                    ...
                    <div className="form-group">
                        ...
                        {editForm.existingImages.length === 0 ? (
                            <p className="section-hint">No saved images yet.</p>
                        ) : (
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {image.id ? (
                                                ...
                                                <p className="section-hint">Legacy image</p>
                                            )}
                                        </div>
                                    );
                                })}
                    ...
                    <div className="form-actions">
                        <button type="button" className="btn btn-secondary" onClick={handleCancelEdit} disabled={submittingEdit}>
                            Cancel
                        </button>
